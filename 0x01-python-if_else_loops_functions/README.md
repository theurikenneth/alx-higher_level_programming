## PROJECT DESCRIPTION
This is a python project that describes if and else statements, loops and functions.
...
4. 4-print_hexa.py - Write a program that prints all numbers from 0 to 98 in decimal and in hexadecimal (as in the following example)
